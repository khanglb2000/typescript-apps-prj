...
const reducer = ( state: CartStateType, action: ReducerAction): CartStateType => {
    switch (action.type) {
        case REDUCER_ACTION_TYPE.ADD: {
            ...
            return { ...state, cart: [ ...filterdCart, { sku, name, price, quantity}]}
        }
        ...
        case REDUCER_ACTION_TYPE.QUANTITY: {
            ...
            if(!itemExists) {
                throw new Error('Item must exist in order to update quality');
            }
...
const useCartContext = (initCartState: CartStateType) => {
    ...
    const totalPrice = new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'vnd'}).format(
